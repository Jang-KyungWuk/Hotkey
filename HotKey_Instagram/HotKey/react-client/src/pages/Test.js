    ...
    <div>
      ...
      <button
        onClick={() => {
          ...
          //팝업창 옵션 (창 크기 조절 등 조정)
          const popupOption = "width=720, height=640, status=no;";
          window.open(
            "http://localhost:5000/manage/test/network/윤도현.html",
            "",
            popupOption
          );
        }}
      ...
      {typeof data.all_blocked === "undefined" ? (
        ...
        <span>
          <br />
          <h1>Account Data successfully fetched from server... (port:5000)</h1>
          <br />
